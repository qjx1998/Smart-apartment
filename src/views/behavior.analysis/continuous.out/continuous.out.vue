    ...
    <div class="container">
        ...
        <div class="list">
            <div class="operations">
                <el-button type="primary" size="small" @click="confirmExport('多日未归人员')">
                    导出
                </el-button>
            </div>
            ...
            <el-table v-loading="loading" border stripe :data="pageData ? pageData.content : []">
                ...
                <el-table-column align="center" label="连续未归天数" prop="dangerBehaviorDays" />
                <el-table-column align="center" label="最近离开时间" prop="lastCaptureDate">
...
<script>
import continuousOut from './continuous.out';
export default continuousOut;
</script>
