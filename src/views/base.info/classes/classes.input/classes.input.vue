            ...
            <div class="input-container">
                <div class="input">
                    ...
                    >
                        ...
                        <el-form-item label="所属学校" class="input-item" prop="collegeId">
                        ...
                        <el-form-item label="所属年级" class="input-item" :required="true" prop="gradeId">

                            <el-select v-model="editingObject.gradeId" filterable>
                                <el-option
                        ...
                        <el-form-item label="班主任" style="width: 44%" prop="masterId">
                            <el-select v-model="editingObject.masterId" filterable>
...
<script>
export { default } from './classes.input';
</script>
