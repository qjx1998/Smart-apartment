...
export default class ContinuousOut {
    /**
     * 人员
     */
    subject;
...
export class ContinuousOutPagingParams extends Page {
    /**
     * 姓名
     */
    name;
    ...
    constructor(page, size, total, name, buildingId, dangerLevel, collegeId, instituteId, classId, departmentId) {
